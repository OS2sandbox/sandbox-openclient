...
# PasswordManagerEnabled: Disables the password manager, which should xalso prevent autofilling passwords
...
TIME=20
URL=https://os2display.aarhuskommune.dk/client 
WIDTH=1920
HEIGHT=1080
ORIENTATION=normal
...
CHROMIUM_SCRIPT='/usr/share/os2openclient/bin/start_chromium.sh'
ROTATE_SCREEN_SCRIPT_PATH="/usr/share/os2openclient/bin/rotate_screen.sh"
